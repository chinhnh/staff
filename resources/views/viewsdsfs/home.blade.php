                ...
                <div id="page-inner">
                            ...
                            <nav class="navbar navbar-inverse navbar-static-top">
                                ...
                                <div class="navbar-collapse collapse" id="menu2">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="{{ asset('show')}}">Danh sách</a></li> 
                                        <li><a href="{{ asset('dangnhap')}}">Thêm tt</a></li>  
                                        <li><a href="index.php/home/thisinh/diem-thi">category 1</a></li>
                                        <li><a href="index.php/home/thisinh/khoi-thi">category 1</a></li>
                                        <li><a href="index.php/home/thisinh/khu-vuc">category 1</a></li>
                                        <li><a href="index.php/home/thisinh/phong-thi">category 1</a></li>
                                        <li><a href="index.php/home/thisinh/ton-giao">category 1</a></li>
                                        <li><a href="index.php/home/thisinh/dan-toc">category 1</a></li>
                    ...
                    <div class="col-md-12" style="margin: 20px 0px;">
                        ...
                        <table class="table table-striped table-bordered table-responsive">
                            ...
                            <tbody>
                                <?php
                                $data = DB::table('tt_thisinh')->get();
                                foreach ($data as $key => $value) {
                                    ?>

                                    <tr>
                                        <td>{{ $value->so_bao_danh}}</td>
                                        <td>{{ $value->ho_ten}}</td>
                                        ...
                                        <td>{{ $value->dia_chi}}</td>
                                        <td>{{ $value->so_cmt}}</td>
                                        <td>{{ asset('/delete/')}}/{{ $value->so_bao_danh }}</td>
                                        <td><a href="./showtt/{{ $value->so_bao_danh }}"><i class="fa fa-check fa-2x"></i></a></td>
                                        <td><a href="./showdiem/{{ $value->so_bao_danh }}"><i class="fa fa-check fa-2x"></i></a></td>
